...
export default function LandingPage() {
  ...
  const features = [
    {
      ...
      desc: "Generate SRS, WBS, Test Cases, and meeting summaries in seconds with advanced AI.",
      color: "blue"
    },
    {
    ...
    },
    {
      ...
      desc: "Seamlessly sync with Jira, Trello, GitHub, and your entire workflow.",
      color: "indigo"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-200 rounded-full px-4 py-2 mb-8 animate-fade-in">
              ...
              <span className="text-sm font-semibold text-indigo-700">AI-Powered Documentation Platform</span>
            </div>
            ...
            <p className="text-xl sm:text-2xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto">
              Stop wasting hours on documentation. Let AI generate, validate, and maintain your project docs automatically.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Powerful features designed to supercharge your documentation workflow
            </p>
          </div>
      ...
      <section id="how-it-works" className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Three simple steps to automated documentation</p>
          </div>
              ...
              {[
                {
                  ...
                  desc: "Integrate with Jira, GitHub, Trello, or import existing docs in seconds.",
                  icon: <Zap className="w-8 h-8" />
                },
                {
                  step: "02",
      ...
      {/* ================= INTEGRATIONS ================= */}
      <section id="integrations" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-white">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 rounded-3xl p-12 sm:p-16 text-center text-white shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                Join hundreds of teams saving 10+ hours every week on documentation
              </p>
              ...
              <p className="text-sm opacity-75">
                Have questions? Reach us at <a href="mailto:support@autodocgen.com" className="underline font-semibold">support@autodocgen.com</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-2xl font-bold text-white">AutoDocGen</span>
              </div>
              <p className="text-gray-400 mb-6 max-w-sm">
                The AI-powered documentation platform that saves your team hundreds of hours every month.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <a href="mailto:support@autodocgen.com" className="hover:text-white transition-colors flex items-center gap-2">
          ...
          <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm">© 2024 AutoDocGen. All rights reserved.</p>
